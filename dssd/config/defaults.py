...
_C.MODEL.BACKBONE.NAME = 'dpn92'
_C.MODEL.BACKBONE.OUT_CHANNELS = (704, 1664, 1408, 1408, 1408, 1408) # 40, 20, 10, 5, 3, 1
...
_C.MODEL.DECODER.OUT_CHANNELS = [1408, 512, 512, 512, 512, 512] # [1408, 512, 512, 512, 512, 512]  [1408, 704, 704, 704, 704, 704] [1408, 1408, 1408, 1408, 1664, 704]
_C.MODEL.DECODER.DECONV_KERNEL_SIZE = [2, 2, 2, 2, 2]  # size_320=[3, 1, 2, 2, 2]  size_512=[2, 2, 2, 2, 2]
